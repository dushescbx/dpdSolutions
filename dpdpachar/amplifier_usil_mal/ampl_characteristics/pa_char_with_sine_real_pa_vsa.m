    ...
    fid_1=fopen(['C:\Users\Konstantinov_PA\Desktop\amplifier\ampl_scripts\output_input_signals\input_power_sine_vsa.txt'],'wt');
    fid_2=fopen(['C:\Users\Konstantinov_PA\Desktop\amplifier\ampl_scripts\output_input_signals\output_power_sine_vsa.txt'],'wt');
    
    % цемепхпсел йнлюмдш дкъ цемепюрнпю х юмюкхгюрнпю
    save_file_name = strcat("'C:\Temp\_sine_meas_with_vsa_power=" , num2str(current_dbm));
    
    clear output_array scpi_comms_for_scope_ar scpi_comms_for_generator_ar;
    scpi_comms_for_scope_ar=scpi_coms_for_scope_for_ampl_sine_meas_vsa_settings(save_file_name);
    ...
    scpi_comms_for_scope_ar=scpi_coms_for_scope_for_ampl_sine_meas_vsa_variable(save_file_name);
