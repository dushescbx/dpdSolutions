function symbol_synch_data = conv_unsync_iq_to_sync(apsk, power, data_to_sync, direct)

%% загружаем данные
[ref_data, trace_data] = load_ref_data(apsk, power, direct);
...
symbol_synch_data = symbol_syncronyize(freq_phase_corrected_data, ref_data);
